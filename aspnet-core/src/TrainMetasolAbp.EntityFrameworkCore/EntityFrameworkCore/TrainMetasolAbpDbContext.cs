...
using TrainMetasolAbp.EntityFrameworkCore.Configurations.InventoryTickets;
using TrainMetasolAbp.EntityFrameworkCore.Configurations.Manufacturers;
using TrainMetasolAbp.EntityFrameworkCore.Configurations.Orders;
using TrainMetasolAbp.EntityFrameworkCore.Configurations.ProductCategories;
using TrainMetasolAbp.EntityFrameworkCore.Configurations.Products;
using TrainMetasolAbp.EntityFrameworkCore.Configurations.Promotions;
using TrainMetasolAbp.Inventories;
using TrainMetasolAbp.InventoryTickets;
using TrainMetasolAbp.Manufacturers;
using TrainMetasolAbp.Orders;
using TrainMetasolAbp.ProductAttributes;
using TrainMetasolAbp.ProductCategories;
...
public class TrainMetasolAbpDbContext :
    AbpDbContext<TrainMetasolAbpDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public TrainMetasolAbpDbContext(DbContextOptions<TrainMetasolAbpDbContext> options)
        : base(options)
    {
